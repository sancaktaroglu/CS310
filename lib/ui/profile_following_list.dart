...
class ProfileFollowingList extends StatefulWidget {
  const ProfileFollowingList({Key? key}) : super(key: key);
              ...
              return (snapshots.connectionState == ConnectionState.waiting)
                ...
                child: CircularProgressIndicator(),
                  ...
                  itemBuilder: (context, index){
                    ...
                    if(query.isEmpty && currentUser.following.contains(data['id'])){
                      return ListTile(
                        onTap: (){
                    ...
                    if((data['username'].toString().contains(query.toLowerCase()) || data['fullname'].toString().contains(query.toLowerCase())) && currentUser.following.contains(data['id'])){
                      return ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => OtherProfilePage(data: data,)));
                        },
